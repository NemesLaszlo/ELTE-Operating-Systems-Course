...
pid_t child1()
{
    ...
    if (szal > 0)
    {
		// returns a positive value (which is the process ID of the child process), 
        // this code is executed in the parent process. It simply returns the child's process ID and does nothing else.
        return szal;
    }
    notacommonvalue = 5;
